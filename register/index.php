    ...
    <body>
        <div id="container">
            ...
            <form action="verification.php" method="POST">
                ...
                <input type="password" id="mail2" placeholder="Entrer l'adresse email" name="mail" required>

                <label><b>Confirmation Adresse Email</b></label>
                <input type="password" id="mail2" placeholder="Entrer l'adresse email" name="mail2" required>
